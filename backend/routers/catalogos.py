...
def crear_labor(
    ...
    if data.producto_area_id and not db.query(ProductoArea).filter_by(
        id=data.producto_area_id, sede_id=sede_id
    ).first():
        raise HTTPException(400, "Producto/Área no encontrado")
